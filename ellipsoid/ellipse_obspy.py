...
class ellipse:
    ...
    def __relative_viewpoint(self,pt):
        ...
        #c,s=np.cos(-np.radians(self.theta)),np.sin(-np.radians(self.theta))
        #R_rot=np.array(((c,-s),(s,c))) # counter-clockwise rotation
    ...
    def __absolute_viewpoint(self,pt):
        ...
        #R_rot=np.array(((c,s),(-s,c))) # clock-wise rotation
    ...
    def plot(self):
        ...
        R_rot=ellipse.__ROT_CW(self.theta)
        #c,s=np.cos(self.theta),np.sin(self.theta)
        #R_rot=np.array(((c,s),(-s,c))) # opposite of what is used for x-axis ellipsoid
